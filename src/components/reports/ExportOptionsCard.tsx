...
export default function ExportOptionsCard({ options }: ExportOptionsCardProps): React.ReactElement {
  return (
    <div className="bg-white rounded-2xl border border-gray-100 p-5">
      <h2 className="text-base font-semibold text-gray-900 mb-4">Export Options</h2>
      <div className="grid grid-cols-3 gap-4">
        {options.map(({ title, description, buttonLabel, primary, icon: Icon, iconBg, iconColor, onAction }) => (
