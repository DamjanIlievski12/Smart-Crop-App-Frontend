...
interface NoFieldsPromptProps {
  // Optional page-specific message shown below the heading
  message?: string;
}

export default function NoFieldsPrompt({
  message = "Get started by adding a field. Smart Crop will then give you AI-powered recommendations, weather insights, and disease risk analysis.",
}: NoFieldsPromptProps): React.ReactElement {
  return (
